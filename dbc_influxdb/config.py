"""Reading of YAML configuration files.

The configuration directory passed to :class:`dbc_influxdb.main.dbcInflux`
...
version-controlled) main config directory. See ``example_configs/`` in the
